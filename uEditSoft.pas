...
uses
  ...
  Vcl.ExtCtrls, Vcl.Buttons, XMLIntf, System.ImageList,
...
begin
  ...
  xmlSetItemString(FSoftXMLNode.ChildNodes[ND_MEMO], ND_PARAM_VALUE, icsB64Encode(MemoMemo.Text));
  ...
  xmlSetItemString(FSoftXMLNode.ChildNodes[ND_PARAMSTRINGS1], ND_PARAM_VALUE, icsB64Encode(MemoStrings.Lines.Text));
end;

procedure TfrmEditSoft.btnSoftBrowseClick(Sender: TObject);
begin
  inherited;
  OpenDialog1.InitialDir := ExtractFilePath(lePath.Text);
...
begin
  ...
  MemoMemo.Text := icsB64Decode(xmlGetItemString(FSoftXMLNode.ChildNodes[ND_MEMO], ND_PARAM_VALUE));
  ...
  MemoStrings.Lines.Text := icsB64Decode(xmlGetItemString(FSoftXMLNode.ChildNodes[ND_PARAMSTRINGS1], ND_PARAM_VALUE));
