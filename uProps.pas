...
uses
  ...
  XMLIntf, Vcl.ExtCtrls, Vcl.Buttons,
  ICSSpinLabeledEdit;
...
begin
  ...
  cbShowObjectHints.Checked := xmlGetItemBoolean(FPropertiesXMLNode, ND_PARAM_SHOW_OBJECT_HINTS);
  cbAppBarAutoHide.Checked := xmlGetItemBoolean(FPropertiesXMLNode, ND_PARAM_APPBAR_AUTOHIDE);
...
begin
  ...
  xmlSetItemBoolean(FPropertiesXMLNode, ND_PARAM_SHOW_OBJECT_HINTS, cbShowObjectHints.Checked);
  xmlSetItemBoolean(FPropertiesXMLNode, ND_PARAM_APPBAR_AUTOHIDE, cbAppBarAutoHide.Checked);
